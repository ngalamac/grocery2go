    ...
    <div className="max-w-4xl mx-auto px-4 py-8 md:py-10">
      ...
      {orders.length === 0 ? (
        ...
        <div className="space-y-4">
          {orders.map(o => (
            <a href={`/dashboard/order/${o.id}`} key={o.id} className="bg-white rounded-lg shadow-sm p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 hover:shadow transition">
              <div>
